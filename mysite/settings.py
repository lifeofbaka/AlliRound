...
class MyAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        from route_data.load_routes import routes
        print(routes)
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # This is for session management
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',  # This is for CSRF protection
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # This is for user authentication
